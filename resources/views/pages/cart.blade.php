                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                @if($product->qty < 5 && $product->qty > 1 )
                                    <a href="/gio-hang/xoa-cap-nhat/{{$product->id}}" style="float: left; margin-right: 15px;"><span class="glyphicon glyphicon-minus-sign"></span></a>
                                    <input type="text" id="qty" name="qty" value="{{ $product->qty}}" class="form-control" style="width: 50px;height: 30px; float: left;">
                                    <a href="/gio-hang/cap-nhat/{{$product->id}}"><span class="glyphicon glyphicon-plus-sign"></span></a>
                                @elseif($product->qty >= 5)
                                    <a href="/gio-hang/xoa-cap-nhat/{{$product->id}}" style="float: left; margin-right: 15px;"><span class="glyphicon glyphicon-minus-sign"></span></a>
                                    <input type="text" id="qty" name="qty" value="{{ $product->qty}}" class="form-control text-center" style="width: 50px; height: 30px; float: left; " disabled="disabled">
                                    <a href=""><span class="glyphicon glyphicon-plus-sign"></span></a>
                                @elseif($product->qty <= 1)
                                    <a href="" style="float: left; margin-right: 15px;" ><span class="glyphicon glyphicon-minus-sign"></span></a>
                                    <input type="text" id="qty" name="qty" value="{{ $product->qty}}" class="form-control" style="width: 50px;height: 30px; float: left;" disabled="disabled">
                                    <a href="/gio-hang/cap-nhat/{{$product->id}}"><span class="glyphicon glyphicon-plus-sign"></span></a>
                                @endif
                                </div>
                            </td>
