			...
			<div class="row">
		        <div class="col-xs-12 col-sm-12 col-md-12">
			    	<h3 class="panel-title">
				    	<span class="glyphicon glyphicon-home" style="font-size: 10px;"></span><a href="{!!url('/home')!!}" title=""> Home</a> 
				        <span class="glyphicon glyphicon-chevron-right" style="font-size: 10px;"></span><a href="{!!url('/home')!!}" title=""> Điện thoại</a>
				...
				<div class="col-xs-12 col-sm-12 col-md-4 product-promotion">
					<div class="row">
						...
						<div class="col-xs-6 col-sm-6 col-md-6">
							@if($product->sale_price !== null)
	                        	<label class="label label-warning" style="margin-left: 20px;">Đã giảm {!! number_format((($product->price-$product->sale_price)/$product->price)*100, 2) !!} %</label>
		                    @endif
						</div>
					</div>
                    <!-- end show price -->
							...
							<div class="table-responsive">
			                    <table class="table table-hover">
			                      ...
			                      <tbody>
			                        ...
			                        <tr>
			                          <td>CPU</td>
			                          <td>{!! $product->operaSystem->gpu_speed !!}</td>
			                        </tr>
			                        <tr>
			                          <td>RAM</td>
									...
									<div class="detail">
										<div class="product-details">
											<ul class="list-group" style="width: 200%;">
											  ...
											  <li class="col-md-8 list-group-item">{!! $product->operaSystem->gpu_speed !!}</li>
											  <li class="col-md-4 list-group-item">Chip đồ họa (GPU)</li>
											  <li class="col-md-8 list-group-item">{!! $product->operaSystem->gpu !!}</li>
											  ...
											  <li class="col-md-7 list-group-item">{!! $product->design->material !!}</li>
